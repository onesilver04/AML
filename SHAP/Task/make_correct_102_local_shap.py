...
DEFAULT_INPUT = PROJECT_ROOT / "SHAP/Task/correct_102.csv"
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "SHAP/Task/correct_102_local_shap"


def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "Create local SHAP JSON files for samples listed in correct_102.csv, "
